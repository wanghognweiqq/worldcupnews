package com.example.administrator.shijeibei.Layout;
...
public class RefreshableView extends LinearLayout implements View.OnTouchListener {
     ...
     * 释放立即刷新状态
     */
    public static final int STATUS_RELEASE_PULL_TO_REFRESH = 1;
    /**
     * 正在刷新状态
     */
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (ableToPull) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (currentStatus != STATUS_REFRESHING) {
                        if (headermarginLayoutParams.topMargin > 0) {
                            currentStatus = STATUS_RELEASE_PULL_TO_REFRESH;
                        }else {
                            currentStatus = STATUS_PULL_TO_REFRESH;
                        }
                        //通过偏移下拉头的top.Margin值，来实现下拉效果
                    ...
                    case MotionEvent.ACTION_UP:
                        default:
                            if (currentStatus == STATUS_RELEASE_PULL_TO_REFRESH) {
            ...
            //时刻记得更新下拉头中的信息
            if (currentStatus == STATUS_PULL_TO_REFRESH  || currentStatus == STATUS_RELEASE_PULL_TO_REFRESH) {
                updateHeaderView();
                //当前正处于下拉或释放状态，要让ListView失去焦点，否则被点击的哪一项会一直处于被选中状态
    ...
    private void updateHeaderView(){
        if (lastStatus != currentStatus) {
            if (currentStatus == STATUS_PULL_TO_REFRESH) {
                ...
                rotateArrow();
            }else if (currentStatus == STATUS_RELEASE_PULL_TO_REFRESH) {
